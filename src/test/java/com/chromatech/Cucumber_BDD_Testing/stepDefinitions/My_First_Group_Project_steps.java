...
public class My_First_Group_Project_steps {
    ...
    public void the_user_enters_username_in_username_text_box(String username) {
        CommonMethods.sendKeys(loginPage1.usernameTextBox, username);
        //LoginPage1.usernameTextBox.sendKeys(username);// other way to do it
    ...
    public void the_user_enters_password_in_password_text_box(String password) {
        CommonMethods.sendKeys(loginPage1.passwordTextBox, password);
    ...
    public void clicks_on_sign_in_button() {
        CommonMethods.click(loginPage1.signInButton);
