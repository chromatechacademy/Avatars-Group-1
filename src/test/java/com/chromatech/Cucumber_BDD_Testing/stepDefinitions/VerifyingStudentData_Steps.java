...
public class VerifyingStudentData_Steps {
    ...
    @When("the user navigates to the detailed student information page {string}")
    public void the_user_navigates_to_the_detailed_student_information_page(String adminssionNumber) {
        stepsImplementation.the_user_navigates_to_the_detailed_student_information_page(adminssionNumber);
    }
